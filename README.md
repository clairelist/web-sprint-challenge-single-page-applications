...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMatch is used for dynamic routing within an application ie navigating imperitvely.

1. How would you explain form validation to someone who has never programmed before?
    Ensuring that what the end user types into various forms is of the correct 'style' ie email has the proper format, password is a certain number of characters etc.

1. In 1-2 sentences, define end to end testing.
    Automatic testing run by software of the whole of an app, so that errors can be caught before production.
